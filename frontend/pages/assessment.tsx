  ...
  return (
    <Layout>
      <Stack direction="column" gap={2} py={6}>
        ...
        <Text>
          กรอกแบบสอบถามเพื่อประเมินความเสี่ยงที่จะเกิดโรคหัวใจล้มเหลวภายในระยะเวลา
          3 ปี โดยความเสี่ยงแบ่งได้เป็น 4 ระดับขึ้นกับผลการทำนาย (1)
          ความเสี่ยงต่ำ ผลการทำนายน้อยกว่า 3% (2) ความเสี่ยงปานกลาง
          ผลการทำนายระหว่าง 3 ถึง 5 % (3) ความเสียงสูง ผลการทำนายระหว่่าง 5 ถึง
          10 % (4) ความเสี่ยงสูงมาก ผลการทำนายมากกว่า 10%
        </Text>
        <VStack gap={4}>
          <TableContainer>
