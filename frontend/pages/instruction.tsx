    ...
    <Layout>
      <Stack direction="column" gap={2} pt={6}>
        ...
        <Box>
          <OrderedList pl={4}>
            <ListItem>
              ...
              ผู้ใช้สามารถกดกากบาทที่มุมขวาบนเพื่ออัพโหลดไฟล์ใหม่ได้
              <br />
              [ภาพ]
            </ListItem>
        ...
        <Box>
          <OrderedList pl={4}>
            <ListItem>
              กรอกข้อมูลผ่านแบบฟอร์ม ได้แก่ อายุ เพศ และประวัติโรคต่างๆ
              <br />
              [ภาพ]
            </ListItem>
            ...
            <ListItem>
              ...
              <br />
              (3) ความเสี่ยงสูง ผลการทำนายระหว่าง 5 ถึง 10 %
              <br />
